...
function SignInAccountant() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Kiểm tra role có phải là ACCOUNTANT không
        console.log('[SignIn Accountant] Full result:', result);
        console.log('[SignIn Accountant] User object:', result.user);
        console.log('[SignIn Accountant] Role object:', result.user?.role);
        const userRole = result.user?.role?.role_name;
        console.log('[SignIn Accountant] User role:', userRole);
...
export default SignInAccountant;
